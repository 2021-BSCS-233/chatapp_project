    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          counterText: '',
          isCollapsed: true,
          contentPadding: EdgeInsets.fromLTRB(prefix_icon != null ? 5.0 : 15, contentTopPadding == null ? 6.5 : contentTopPadding!, 5.0, 5.0),
          //made it so if you pass all_inclusive icon it becomes invisible as a temp solution for this field height not working problem
          ...
          border: OutlineInputBorder(
            borderRadius:
                BorderRadius.all(Radius.circular(field_radius ?? 25)),
